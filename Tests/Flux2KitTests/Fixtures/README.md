...
Refresh this fixture intentionally with `FLUX2_REPO=... Scripts/refresh_goldens.sh`, review the image
diff, then run `FLUX2_RUN_IMAGE_TESTS=1 FLUX2_REPO=... swift test --filter imageQuality`.
