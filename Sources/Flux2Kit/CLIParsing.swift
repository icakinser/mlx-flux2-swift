// Flux2Kit — pure, testable parsing helpers for the CLI. These live in the library (not the
// executable target) so they can be unit-tested. They throw `CLIParseError` on malformed input
...
public func parseIntArg(_ flag: String, _ value: String) throws -> Int {
...
public func parseDoubleArg(_ flag: String, _ value: String) throws -> Double {
...
public func parseFloatArg(_ flag: String, _ value: String) throws -> Float {
...
public func parseUInt64Arg(_ flag: String, _ value: String) throws -> UInt64 {
...
public func parseWxHArg(_ s: String) throws -> (Int, Int) {
...
public func parse4Arg(_ flag: String, _ s: String) throws -> (Int, Int, Int, Int) {
...
public func parseOutpaintArg(_ s: String) throws -> (Int, Int, Int, Int) {
...
public struct RecolorSpec: Equatable {
...
public func parseRecolorArg(_ s: String) -> RecolorSpec {
